...
export default function FormsOfParticipation() {
    ...
    const list = ['Radionica','Primjer dobre prakse','Znanstveni i stručni radovi','Poster','Okrugli stol','Simpozij','Ted talk','Out of the box'];
    const listDescription = ['Interaktivno učenje i poučavanje sudionika o odabranoj temi, kojim se kod njih razvija neka vještina ili osjetljivost za neki problem.'
    ...
    <div>
      ...
      <Row> 
        <Col>
          <CardGroup  > 
          <Card > 
        <Card.Img variant="top" className='card-img' src="https://i0.hippopx.com/photos/168/829/316/faculty-workshop-professional-training-academic-preview.jpg"/>
        ...
        <Col>
           <CardGroup  > 
           <Card > 
        <Card.Img variant="top" className='card-img' src="https://www.thebluediamondgallery.com/handwriting/images/practice.jpg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
        ...
        <Col>
          <CardGroup  > 
          <Card > 
        <Card.Img variant="top" className='card-img' src="https://c0.wallpaperflare.com/preview/817/823/802/knowledge-spark-flash-hand.jpg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
        ...
        <Col>
          <CardGroup  > 
          <Card > 
        <Card.Img variant="top" className='card-img' src="https://c1.wallpaperflare.com/preview/812/952/1011/brain-mind-psychology-idea.jpg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
      ...
      <Row> 
        <Col>
          <CardGroup  > 
          <Card > 
        <Card.Img variant="top" className='card-img' src="https://i0.hippopx.com/photos/495/478/444/team-table-playmobil-round-table-preview.jpg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
        ...
        <Col>
           <CardGroup  > 
           <Card > 
        <Card.Img variant="top" className='card-img' src="https://c1.wallpaperflare.com/preview/677/164/866/audience-speech-speaker-presentation.jpg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
        ...
        <Col>
          <CardGroup  > 
          <Card > 
        <Card.Img variant="top" className='card-img' src="https://pb-assets.tedcdn.com/system/baubles/files/000/001/441/original/TEDWomen2015_attend_hero.jpg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
        ...
        <Col>
          <CardGroup  > 
          <Card > 
        <Card.Img variant="top" className='card-img' src="https://upload.wikimedia.org/wikipedia/commons/1/11/Thinking_out_of_the_box_4.svg"/>
        {/* // src={require('C:\\Users\\misla\\web-jelk\\src\\assets\\jelkovec-zrak2.jpg')}  */}
        <Card.Body>
